    ...
    public class ZigZagSquadron : ISquadron {
        ...
        public void CreateEnemies (List<Image> enemyStride,
            ...
            //var images = ImageStride.CreateStrides(4, Path.Combine("Assets", "Images", "BlueMonster.png"));
                ...
                Enemies.AddEntity(new Enemy(
                    new DynamicShape(new Vec2F(0.1f + (float) 1 * 0.1f, 0.7f), new Vec2F(0.1f, 0.1f)),
                    new ImageStride(80, enemyStride), new ImageStride(80,alternativeEnemyStride), 0.0f
                ));
                Enemies.AddEntity(new Enemy(
                ...
                Enemies.AddEntity(new Enemy(
                    new DynamicShape(new Vec2F(0.1f + (float) 3 * 0.1f, 0.7f), new Vec2F(0.1f, 0.1f)),
                    new ImageStride(80, enemyStride), new ImageStride(80,alternativeEnemyStride), 0.0f
                ));
                Enemies.AddEntity(new Enemy(
                ...
                Enemies.AddEntity(new Enemy(
                    new DynamicShape(new Vec2F(0.1f + (float) 5 * 0.1f, 0.7f), new Vec2F(0.1f, 0.1f)),
                    new ImageStride(80, enemyStride), new ImageStride(80,alternativeEnemyStride), 0.0f
                ));
                Enemies.AddEntity(new Enemy(
                ...
                Enemies.AddEntity(new Enemy(
                    new DynamicShape(new Vec2F(0.1f + (float) 7 * 0.1f, 0.7f), new Vec2F(0.1f, 0.1f)),
                    new ImageStride(80, enemyStride), new ImageStride(80,alternativeEnemyStride), 0.0f
                ));
        }
